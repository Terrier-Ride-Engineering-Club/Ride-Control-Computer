...
class TestRideControlComputer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rcc.io.read_ride_off = MagicMock(return_value=False)
    ...
    def test_reset_logic_from_estopped(self):
        ...
        self.rcc._state = State.ESTOPPED
    ...
    def test_reset_logic_to_idle(self):
        ...
        self.rcc._state = State.RESETTING
    ...
    def test_ride_off_transitions_to_off(self):
        ...
        self.rcc._state = State.IDLE
        self.rcc.io.read_ride_off.return_value = True
        self.rcc.update()
        self.assertEqual(self.rcc.state, State.OFF)
