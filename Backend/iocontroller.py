...
SLOW_SPEED_QPPS = int(QUAD_COUNTS_PER_REVOLUTION / 10)     # 1 revolution every 10 seconds
MED_SPEED_QPPS = int(QUAD_COUNTS_PER_REVOLUTION / 7)    # 1 revolution every 7 seconds
